...
var render = function () {
  ...
  return _c(
    "footer",
    {
      staticClass: "footer_area bg-black relative z-10",
      attrs: { id: "footer" },
    },
    [
      _vm._m(0),
      ...
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "footer_widget pt-18 pb-120" }, [
          _c("div", { staticClass: "row justify-center" }, [
            _c("div", { staticClass: "w-full md:w-1/2 lg:w-3/12" }, [
              _c("div", { staticClass: "footer_about mt-7 mx-3" }, [
                _c("div", { staticClass: "footer_logo" }, [
                  _c("a", { attrs: { href: "/" } }, [
                    _c(
                      "svg",
                      {
                        staticClass: "h-16 text-theme-color",
                        attrs: {
        ...
        _c(
          ...
          {
            staticClass:
              "footer_copyright pt-3 pb-6 border-t-2 border-solid border-white border-opacity-10 sm:flex justify-between",
          },
          [
            _c("div", { staticClass: "footer_social pt-4 mx-3 text-center" }, [
              _c(
                "div",
                {
                  staticClass: "flex items-center justify-center space-x-4 h-6",
                },
                [
                  _c(
                    "ul",
                    {
                      staticClass:
                        "social flex justify-center sm:justify-start",
                    },
                    [
                      _c("li", { staticClass: "mr-3" }, [
                        _c(
                          ...
                          {
                            staticClass:
                              "transition-colors duration-300 hover:text-sky-700 h-full",
                            attrs: {
                              href: "https://t.me/ChernobayDev",
                              target: "_blank",
                              rel: "nofollow",
                              title: "Telegram",
                            },
                        ...
                        _c(
                          "a",
                          {
                            staticClass:
                              "transition-colors duration-300 hover:text-sky-700 h-full",
                            attrs: {
                              href: "https://twitter.com/ChernobayDev",
                              target: "_blank",
                              rel: "nofollow",
                              title: "Twitter",
                            },
                        ...
                        _c(
                          "a",
                          {
                            staticClass:
                              "transition-colors duration-300 hover:text-sky-700 h-full",
                            attrs: {
                              href: "mailto:yura.chernobay@gmail.com",
                              target: "_blank",
                              rel: "nofollow",
                              title: "Email",
                            },
                        ...
                        _c(
                          "a",
                          {
                            staticClass:
                              "transition-colors duration-300 hover:text-sky-700 h-full",
                            attrs: {
                              href: "https://dev.chernobay.com.ua",
                              target: "_blank",
                              rel: "nofollow",
                              title: "Website",
                            },
...
var staticRenderFns = [
  function () {
    ...
    return _c(
      ...
      {
        staticClass:
          "shape absolute left-0 top-0 opacity-5 h-full overflow-hidden w-1/3",
      },
      [
        _c("img", {
          attrs: { src: "assets/images/footer-shape-left.png", alt: "" },
        }),
      ]
    )
  },
  function () {
    ...
    return _c(
      ...
      {
        staticClass:
          "shape absolute right-0 top-0 opacity-5 h-full overflow-hidden w-1/3",
      },
      [
        _c("img", {
          attrs: { src: "assets/images/footer-shape-right.png", alt: "" },
        }),
      ]
    )
  },
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "footer_content mt-8" }, [
      _c("p", { staticClass: "text-white" }, [
        _vm._v("Hello! This is a API test page. Write questions to my mail:"),
      ]),
      _vm._v(" "),
      _c(
        "a",
        {
          staticClass: "text-white mt-4 hover:text-theme-color",
          attrs: { href: "mailto:yura.chernobay@gmail.com" },
        },
        [_vm._v("yura.chernobay@gmail.com")]
      ),
    ])
  },
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-full md:w-1/2 lg:w-5/12" }, [
      _c("div", { staticClass: "footer_link_wrapper flex flex-wrap mx-3" }, [
        _c("div", { staticClass: "footer_link w-1/2 md:pl-13 mt-13" }, [
          _c(
            "h2",
            { staticClass: "footer_title text-xl font-semibold text-white" },
            [_vm._v("Contacts")]
          ),
          _vm._v(" "),
          _c("ul", { staticClass: "link pt-4" }, [
            _c("li", [
              _c(
                "a",
                {
                  staticClass: "text-white mt-4 hover:text-theme-color",
                  attrs: { href: "https://t.me/ChernobayDev" },
                },
                [_vm._v("Telegram")]
              ),
            ]),
            ...
            _c("li", [
              _c(
                ...
                {
                  staticClass: "text-white mt-4 hover:text-theme-color",
                  attrs: { href: "https://twitter.com/ChernobayDev" },
                },
                [_vm._v("Twitter")]
              ),
            ]),
          ...
          _c("ul", { staticClass: "link pt-4" }, [
            _c("li", [
              _c(
                ...
                {
                  staticClass: "text-white mt-4 hover:text-theme-color",
                  attrs: { href: "https://dev.chernobay.com.ua/" },
                },
                [_vm._v("Main site")]
              ),
            ]),
            ...
            _c("li", [
              _c(
                ...
                {
                  staticClass: "text-white mt-4 hover:text-theme-color",
                  attrs: { href: "https://dev.chernobay.com.ua/portfolio" },
                },
                [_vm._v("Portfolio")]
              ),
            ]),
  ...
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-full md:w-2/3 lg:w-4/12" }, [
      _c("div", { staticClass: "footer_subscribe mt-13 mx-3" }, [
        _c(
          "h2",
          { staticClass: "footer_title text-xl font-semibold text-white" },
          [_vm._v("Subscribe")]
        ...
        _vm._v(" "),
        _c("div", { staticClass: "subscribe_form text-right mt-9 relative" }, [
          _c("form", { attrs: { action: "#" } }, [
            _c("input", {
              staticClass:
                "w-full py-5 px-6 bg-white text-black rounded-full border-none",
              attrs: { type: "text", placeholder: "Not" },
            }),
            _vm._v(" "),
            _c("button", { staticClass: "main-btn subscribe-btn" }, [
              _vm._v("work"),
            ]),
          ]),
        ]),
  ...
  function () {
    ...
    return _c(
      "div",
      { staticClass: "footer_copyright_content pt-4 text-center" },
      [_c("p", { staticClass: "text-white" }, [_vm._v("Copyright - 2022")])]
    )
  },
]
